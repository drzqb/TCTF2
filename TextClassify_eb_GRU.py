...
from tensorflow.keras.layers import Input, Layer, Dense, Dropout, Embedding, Bidirectional, GRU, GlobalAvgPool1D
...
params_check = "modelfiles/textclassify_eb_GRU_bce"
...
class TextClassify():
    ...
    def build_model(self, summary=True):
        ...
        now = GRU(params_rnn_size, name="gru")(now, mask=attn_mask)

        logits = Project(name="project")(now)
...
def main():
    ...
    train_file = [
        'data/TFRecordFile/train_eb_word_fl.tfrecord',  # 正负例极端不均衡
    ]
    val_file = [
